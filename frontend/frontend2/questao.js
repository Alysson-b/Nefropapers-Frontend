...
async function buscarDadosQuestao(questaoId) {
    ...
    const url = `http://147.93.70.83:3000/questoes/${questaoId}`;
...
async function configurarSelecaoResposta() {
    ...
    const gabaritoButton = document.querySelector('.question-button'); // Botão Gabarito
    const questionId = new URLSearchParams(window.location.search).get('questionId');
    const testId = new URLSearchParams(window.location.search).get('testId');
    ...
    submitButton.addEventListener('click', async () => {
        ...
        try {
            const response = await fetch(`http://147.93.70.83:3000/simulados/${testId}/responder`, {
                method: 'POST',
                headers: {
...
function salvarProgressoNoBackend(testId) {
    ...
    fetch(`http://147.93.70.83:3000/simulados/${testId}/progresso`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-API-KEY': localStorage.getItem('apiKey'),
...
//     try {
//         const response = await fetch(`http://147.93.70.83:3000/simulados/${testId}/progresso`, {
//             method: 'POST',
//             headers: {
//                 'Content-Type': 'application/json',
//                 'X-API-KEY': localStorage.getItem('apiKey'),
...
//     try {
//         const response = await fetch(`http://147.93.70.83:3000/simulados/${testId}/finalizar`, {
//             method: 'POST',
//             headers: {
//                 'Content-Type': 'application/json',
//                 'X-API-KEY': localStorage.getItem('apiKey'),
